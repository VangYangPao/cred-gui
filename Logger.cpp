...
static const QString default_name = "cred-wallet-gui.log";
...
void messageHandler(QtMsgType type, const QMessageLogContext &context, const QString &message)
{
    ...
    switch(type)
    {
        case QtDebugMsg: Cred::Wallet::debug(cat, msg); break;
        case QtInfoMsg: Cred::Wallet::info(cat, msg); break;
        case QtWarningMsg: Cred::Wallet::warning(cat, msg); break;
        case QtCriticalMsg: Cred::Wallet::error(cat, msg); break;
        case QtFatalMsg: Cred::Wallet::error(cat, msg); break;
    }
}
