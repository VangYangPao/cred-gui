...
<context>
    ...
    <message>
        ...
        <translation>Майнинг на вашем компьютере помогает обезопасить сеть Cred. Чем больше людей майнит, тем сложнее атаковать сеть, и каждый майнер вносит свой вклад в этот процесс. &lt;br&gt; &lt;br&gt;Майнинг также дает вам небольшой шанс добыть несколько монет Cred. Ваш компьютер будет искать хеши для решения блоков. Если вы найдете блок, то получите вознаграждение. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>С достаточным количеством Cred</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Cred</source>
        <translation>С недостаточным количеством Cred</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия Cred</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками Cred или их клонов, которые смогут повторно использовать ключи Cred.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях Cred потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности Cred.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных входов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом Cred и доступен на веб-сайте getcred.org, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн (и блокчейны клонов Cred) самостоятельно, используя инструмент cred-blockchain-blackball, чтобы создать список известных потраченых входов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Во избежание аннулирования защиты, обеспечиваемой кольцевыми подписями Cred, выход не должен проводиться с разными кольцами на разных блокчейнах. Хотя это, как правило, не вызывает беспокойства, он может стать одним, если какой-то клон Cred, использующий ключ повторно, позволяет вам тратить существующие выходы. В этом случае вам необходимо обеспечить, чтобы эти существующие выходы использовали одно и то же кольцо для обеих цепей.&lt;br&gt;Это может быть сделано автоматически Cred или любым программным обеспечением с возможностью повторного использования ключей, которое не будет пытатся лишить вас конфиденциальности.&lt;br&gt;Если вы используете клон Cred с повторным использованием ключа, и этот клон не включает эту защиту, вы все равно можете гарантировать, что ваши транзакции будут защищены, сделав их сначала на клоне, затем вручную добавить кольцо на этой странице, что позволит вам конфиденциально перевести ваши Cred.&lt;br&gt;Если вы не используете клон Cred с повторным использованием ключей без этих функций безопасности, то вам не нужно ничего делать, поскольку все автоматизировано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на Cred, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Cred отправлены успешно</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Мы почти готовы к работе. Необходимо еще сделать некоторые настройки для Cred</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the Cred blockchain?</source>
        <translation>Запустим блокчейн Cred ?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Майнинг защищает сеть Cred, а также платит небольшую награду за проделанную работу. Эта опция позволяет Cred майнить, когда ваш компьютер включен и простаивает. Когда вы продолжите работать, он прекратит майнинг.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Для того, чтобы обмениваться данными з сетью Cred ваш кошелек должен быть подключен к ноде Cred. Для лучшей конфиденциальности рекомендуется запустить собственную ноду.                         &lt;br&gt;&lt;br&gt;                         Если у вас нет возможности запустить собственную ноду, есть возможность подключится к удаленной ноде.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Разработка Cred полностью поддерживается пожертвованиями</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПОЛЬЗУЙТЕСЬ CRED</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Cred!</translation>
    </message>
    <message>
...
Индекс адреса траты: </translation>
    ...
    <message>
        ...
        <translation>Cred отправлено успешно: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Этот адрес получил %1 CX, с %2 подтверждениями</translation>
    </message>
    <message>
        <location filename="../main.qml" line="873"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Этот адрес получил %1 CX, но транзакции еще не подтверждены майнерами</translation>
    </message>
    <message>
