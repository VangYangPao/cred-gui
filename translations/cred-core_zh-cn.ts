...
<context>
    ...
    <message>
        ...
        <translation>挖矿可增进 Cred 网络的安全性, 越多使用者的挖矿活动, Cred 网络就会越难以被攻击. &lt;br&gt; &lt;br&gt;挖矿也让您有机会赚取额外的门罗币, 您的计算机将持续创建哈希值用以寻找区块, 如找到则可以获得该区块所附带的门罗币奖励, 祝您好运！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>内嵌Cred版本: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>您在本页面可以操作共享的环签名数据库.  Cred 钱包以及复制了 Cred 密钥的克隆钱包都将使用本数据库.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为了掩盖Cred交易中任何付款的去向, 第三方不应知道环签名中每个输入和支付的对应关系. 否则就会削弱环签名提供的保护. 如果仅有一个输入之外的所有输入都已知, 那么所有付款的去向将变得透明, 这将使作为Cred三个主要隐私保护层之一的环签名彻底无效.  &lt;br&gt; 为帮助交易中避免出现这些问题, 可以使用已知去向列表来避免在新交易中使用它们.  这个清单由 Cred 项目维护, 可在 getcred.org 网站上找到, 您可以在此处导入此清单. &lt;br&gt; 或者, 您可以自己扫描区块链 (以及复制了 Cred 密钥的克隆钱包的区块链),  使用cred-blockchain-blackball工具创建已知已用输出的列表. &lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为了避免Cred环签名提供的保护无效, 同一个输出不应该在不同的区块链上使用不同的环签名来支付.  虽然这通常不是一个问题, 但是当复制了 Cred 密钥的克隆钱包允许您支付到现有输出时, 它可以成为一个问题.  在这种情况下, 您需要确保这些现有输出在两条链上都使用相同的环签名. &lt;br&gt;这将由Cred和任何不想破坏您隐私权的密钥重用软件自动完成.  &lt;br&gt; 如果您同时在使用复制了 Cred 密钥的克隆钱包, 并且不包含这种保护, 您仍然可以通过在它之上新的交易来确保您的交易安全, 然后在此页面上手动添加环签名, 从而使您安全地使用Cred. &lt;br&gt;如果您没有使用无此安全功能的克隆钱包, 那么您不需要做任何事情, 因为所有都是自动的.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>这个环签名已在密钥重用的Cred链上使用过, 因此重复使用同一个环签名可以避免隐私问题. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>就快完成了 - Cred 还需要一点设置</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the Cred blockchain?</source>
        <translation>开始同步 Cred 区块链?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>硬盘节约模式能精简区块链的数据而减少硬盘空间的使用量, 但保存完整的区块链能加强 Cred 网络的安全性, 当您需要在容量较小的硬盘上执行, 那么这个功能就很适合您, 此功能对于网络带宽的用量没有影响. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>启动挖矿功能可让 Cred 的系统网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>为了能与Cred网络进行通讯, 您的钱包需要连接上一个Cred节点. 为了获得最好的隐私, 我们建议您运行一个自己的节点 &lt;br&gt;&lt;br&gt; 如果您无法运行自己的节点, 可以选择连上一个远程的节点. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Cred的开发完全由捐赠所支持</translation>
    </message>
    <message>
        <location filename="../wizard/WizardDonation.qml" line="113"/>
        <source>Enable auto-donations of?</source>
        <translation>激活自动捐赠给Cred的开发团队?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在每一笔交易中 Cred 系统都会收取小额的手续费, 而这个选项则是让你可以增加额外的金额捐赠 Cred 的开发, 比例以当次交易的手续费为基础计算, 譬如 50% 的自动捐赠意味着如果转账手续费为 0.005CX时将会额外捐赠 0.0025 CX 给 Cred 开发团队. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Mining secures the Cred network, and also pays a small reward for the work done. This option will let Cred mine when your computer is on mains power and is idle. It will stop mining when you continue working.</source>
        <translation>启动挖矿功能可让 Cred 的网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>使用 CRED</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>欢迎使用 Cred！</translation>
    </message>
    <message>
...
Spending address index: </source>
    ...
    <message>
        ...
        <translation>Cred转账已成功: %1 个交易</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>这个地址接收了 %1 个cred, 并通过 %2 次的确认. </translation>
    </message>
    <message>
        <location filename="../main.qml" line="873"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>有可用的新版本 Cred 钱包:  %1&lt;br&gt;%2</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>这个地址将收到 %1 个cred币, 但这笔交易尚未被矿工确认</translation>
    </message>
    <message>
