...
<context>
    ...
    <message>
        ...
        <translation>З достатньою кількістю Cred</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Cred</source>
        <translation>З недостатньою кількістю Cred</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вбудована версія Cred: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На цій сторінці можна взаємодіяти із загальною базою даних RingDB. Ця база даних призначена для використання гаманцями Cred або їх клонів, які зможуть повторно використовувати ключі Cred.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того щоб приховати які входи в транзакціях Cred були витрачені, третя сторона не повинна повідомляти які входи в кільці вже задіяні в витраті. Адже якщо це зробити, то це послабить захист, який забезпечується кільцевими підписами. Якщо відомо, що всі, крім одного з входів, вже витрачені, то фактично трата входу стає очевидною, тим самим анулюється ефект кільцевих підписів, одного з трьох основних рівнів захисту конфіденційності Cred.&lt;br&gt;Щоб допомогти транзакціям уникнути витрати цих входів, можна використовувати список відомих витрачених входів, щоб уникнути їх використання в нових транзакціях. Такий список підтримується проектом Cred і доступний на веб-сайті getcred.org, і ви можете імпортувати цей список тут.&lt;br&gt;Крім того, ви можете просканувати блокчейн (і блокчейни клонів Cred) самостійно, використовуючи інструмент cred-blockchain-blackball, щоб створити список відомих витрачених входів.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Щоб уникнути скасування захисту, що забезпечується кільцевими підписами Cred, вихід не повинен проводитися з різними кільцями на різних блокчейнах. Хоча це як правило не викликає занепокоєння, він може стати одним, якщо якийсь клон Cred, що використовує ключ повторно, дозволяє вам витрачати існуючі виходи. В цьому випадку вам необхідно забезпечити, щоб ці існуючі виходи використовували одне і те ж кільце для обох блокчейнів.&lt;br&gt;Це може бути зроблено автоматично, або будь-яким програмним забезпеченням з можливістю повторного використання ключів, яке не спробує позбавити вас конфіденційності.&lt;br&gt;Якщо ви використовуєте клон Cred з повторним використанням ключа, і цей клон не включає цей захист, ви все одно можете гарантувати, що ваші транзакції будуть захищені, зробивши їх спочатку на клоні, потім вручну додати кільце на цій сторінці, що дозволить вам конфіденційно перевести ваші Cred.&lt;br&gt;Якщо ви не використовуєте клон Cred з повторним використанням ключів без цих функцій безпеки, то вам не потрібно нічого робити, оскільки все автоматизовано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Тут записуються кільця, що використовуються виходами проведеними на Cred, так що одне і те ж кільце можна використовувати повторно, щоб уникнути проблем з конфіденційністю.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Cred відправлено успішно</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Режим збереження диску використовує значно менше дискового простору, але такий же обсяг смуги пропускання, як у звичайного запуску Cred. Проте, зберігання повного блокчейну корисно для безпеки мережі Cred. Якщо цей гаманець на пристрої з обмеженим дисковим простором, цей варіант вам підійде.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Майнінг захищає мережу Cred, а також платить невелику нагороду за виконану роботу. Ця опція дозволяє майнити Cred коли ваш комп&apos;ютер ввімкнений і простоює. Коли ви продовжите працювати, майнінг буде призупинено.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Для того, щоб обмінюватися даними з мережею Cred ваш гаманець повинен бути підключений до ноди Cred. Для кращої конфіденційності рекомендується запустити власну ноду.                         &lt;br&gt;&lt;br&gt;                         Якщо у вас немає можливості запустити власну ноду, є можливість підключитися до віддаленої ноди.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Розробка Cred підтримується виключно пожертвами</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>За кожну транзакцію стягується невелика комісія. Ця опція дозволяє вам додати додаткову суму у відсотках від цієї комісії до транзакції, для підтримки розробки Cred. Наприклад, 50% автодотаціі беруть плату за транзакцію 0,005 CX і додають 0,0025 CX на користь підтримки розробки Cred.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ласкаво просимо в Cred!</translation>
    </message>
    <message>
...
Індекс адреса витрати: </translation>
    ...
    <message>
        ...
        <translation>Cred успішно відправлені: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 CX, із %2 підтвердженнями(и)</translation>
    </message>
    <message>
        <location filename="../main.qml" line="875"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 CX, але транзакція ще не була підтверджена майнерами</translation>
    </message>
    <message>
