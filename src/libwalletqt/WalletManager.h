...
public:
    enum LogLevel {
        LogLevel_Silent = Cred::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Cred::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Cred::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Cred::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Cred::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Cred::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Cred::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Cred::WalletManagerFactory::LogLevel_Max,
    };
