...
public:
    enum Direction {
        Direction_In  =  Cred::TransactionInfo::Direction_In,
        Direction_Out =  Cred::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Cred::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Cred::TransactionInfo * m_pimpl;
